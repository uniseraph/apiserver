...
var routers = map[string]map[string]*MyHandler{
	...
	"POST": {
		...
		*/
		...
		"/applications/containers/{id:.*}/restart": &MyHandler{h: restartContainer, opChecker: checkUserPermission, roleset: types.ROLESET_NORMAL | types.ROLESET_APPADMIN | types.ROLESET_SYSADMIN},
