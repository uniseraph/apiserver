...
var routers = map[string]map[string]*MyHandler{
	...
	"POST": {
		...
		*/
		...
		"/applications/{id:[A-Za-z0-9-_]+}/restart":            &MyHandler{h: restartApplication, opChecker: checkUserPermission, roleset: types.ROLESET_APPADMIN | types.ROLESET_SYSADMIN},
		...
		"/lb/domains/{domain:.*}/set-cookie-filter": &MyHandler{h: setVDomainCookieFilter, opChecker: nil, roleset: types.ROLESET_APPADMIN | types.ROLESET_SYSADMIN},
